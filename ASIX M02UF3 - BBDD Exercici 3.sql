...
ALTER TABLE ONLY public.paisos DROP CONSTRAINT paisos_regions_fk;
ALTER TABLE ONLY public.localitzacions DROP CONSTRAINT localitzacions_paisos_fk;
ALTER TABLE ONLY public.historial_treballs DROP CONSTRAINT historial_treballs_treballs_fk;
ALTER TABLE ONLY public.historial_treballs DROP CONSTRAINT historial_treballs_departaments_fk;
ALTER TABLE ONLY public.empleats DROP CONSTRAINT empleats_treballs_fk;
ALTER TABLE ONLY public.departaments DROP CONSTRAINT departaments_localitzacions_fk;
ALTER TABLE ONLY public.departaments DROP CONSTRAINT departaments_cap_fk;
ALTER TABLE ONLY public.treballs DROP CONSTRAINT treballs_pk;
ALTER TABLE ONLY public.regions DROP CONSTRAINT regions_pk;
ALTER TABLE ONLY public.paisos DROP CONSTRAINT paisos_pk;
ALTER TABLE ONLY public.localitzacions DROP CONSTRAINT localitzacions_pk;
ALTER TABLE ONLY public.historial_treballs DROP CONSTRAINT historial_treballs_pk;
ALTER TABLE ONLY public.empleats DROP CONSTRAINT empleats_pk;
ALTER TABLE ONLY public.departaments DROP CONSTRAINT departament_pk;
DROP TABLE public.treballs;
DROP TABLE public.regions;
DROP TABLE public.paisos;
DROP TABLE public.localitzacions;
DROP TABLE public.historial_treballs;
DROP TABLE public.empleats;
...
ALTER TABLE departaments OWNER TO postgres;
...
ALTER TABLE empleats OWNER TO postgres;
...
ALTER TABLE historial_treballs OWNER TO postgres;
...
ALTER TABLE localitzacions OWNER TO postgres;
...
ALTER TABLE paisos OWNER TO postgres;
...
ALTER TABLE treballs OWNER TO postgres;




ALTER TABLE vista_empleats OWNER TO postgres;
...
ALTER TABLE ONLY historial_treballs
...
ALTER TABLE ONLY localitzacions
